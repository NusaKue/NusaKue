...
const UMKMCard = ({
  ...
  if (imgPosition === "bottom") {
    return (
      <div className="card umkm-list w-full bg-white rounded-lg shadow-md flex flex-col text-primary-100">
        <div className="overflow-hidden rounded-t-lg">
          <img src={image_url || "/assets/images/placeholder-image.jpg"} alt="alt" className="w-full h-40 object-cover" />
        </div>
  ...
  if (imgPosition === "top") {
    return (
      <div className="card umkm-list flex flex-col bg-white rounded-lg shadow-md w-full sm:max-w-[calc(50%-0.75rem)] md:max-w-[calc(50%-0.75rem)] lg:max-w-[calc(33.333%-1rem)] xl:max-w-[calc(25%-1.25rem)]">
        <div className="overflow-hidden rounded-t-lg">
          <img src={image_url} alt={nama} className="w-full bg-cover object-cover" />
        </div>
