  ...
  return (
    <section className="about-nusa px-6 sm:px-8 md:px-12 lg:px-24 py-8 sm:py-10 md:py-14 lg:py-16">
      ...
      <div className="about-desc">
        <p className="font-poppins text-body-md-regular lg:text-body-lg-regular text-center text-primary-100">
          Sebuah proyek kolaborasi yang menyatukan keahlian di bidang Front-End,
          Back-End, dan Machine Learning untuk melestarikan warisan kuliner
